...
// const activeTabs = {
//   home: navigation.find((route) => route.href === "/"),
//   team: navigation.find((route) => route.href === "#team"),
//   projects: navigation.find((route) => route.href === "#projects"),
//   calendar: navigation.find((route) => route.href === "#calendar"),
// };
                    ...
                    <div className="flex space-x-4">
                      {navigation.map((item: IAllTabs) => (
                        <Link
                          ...
                          aria-current={
                            item.href === tabRoute ? "page" : undefined
                          }
                        >
                          {item.name}
                        </Link>
